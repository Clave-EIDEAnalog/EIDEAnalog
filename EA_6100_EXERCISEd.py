...
# File: EA_6100_EXERCISEd.py                                                #
#                                                                           #
# Archivo: EA_6100_EXERCISEd.py                                             #
...
for i in range(loops):
    ...
    while not(myBus.ready()):
        pass
    conversion = myBus.readConversion()
    
total_time = time.time() - start_time
print ("Samples per second:", (1/total_time)*loops)
print ("Average time per sample", (total_time/loops))
